...
void Server::sendToChannel(std::string str, std::string channel_name, int sender_fd) { _channels[channel_name].sendToChannel(str, sender_fd); }

void Server::addClientToChan(std::string channel_name, int cfd) { _channels[channel_name].AddClient(cfd); }
